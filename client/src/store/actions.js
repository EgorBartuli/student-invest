...
export const getInvestorsAC = (data) => ({ type: ACTypes.GET_INVESTORS, payload: { data } });
...
export const profileAC = (data) => {
  if (data) {
    ...
    return { type: ACTypes.PROFILE, payload: { photo, info, interests, language, country } };
  } else {
    return { type: ACTypes.PROFILE, payload: {} };
  }
};
...
export const connectionsAC = (data) => ({ type: ACTypes.CONNECTIONS, payload: { data } });
